...
class keras_endoLSTM(object):
    def __init__(self, args, newModel):
        ...
        if newModel:
            ...
            # only feed in the total time to finish the workout
            self.inputAtts = ['distance', 'altitude', 'time_elapsed']
    ...
    def build_model(self, args):
        ...
        if self.includeTemporal:
            ...
            context_embedding_1 = Dropout(
                0.1, name='context_dropout_1')(context_embedding_1)
            context_embedding_2 = Dropout(
                0.1, name='context_dropout_2')(context_embedding_2)
            context_embedding = Dense(self.context_dim, activation='selu', name='context_projection')(
                concatenate([context_embedding_1, context_embedding_2]))
